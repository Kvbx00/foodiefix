    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div
                ...
                <h1 class="h2">Dodawanie listy zakupów</h1>
            </div>

            <form action="{{ route('administrator.saveUserShoppingList') }}" method="POST">
                @csrf
                ...
                <button type="submit" class="btn btn-secondary my-3">Dodaj listę</button>
            </form>
